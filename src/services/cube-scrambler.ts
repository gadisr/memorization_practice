...
export function scramble_cube(scramble: string): CubeState {
  ...
  for (let i = 0; i < moves.length; i++) {
    ...
    if (move) {
      ...
      // Show color state after each move
      console.log('📊 Color state after move:');
      console.log('  U (white):', cube.faces.U.colors[0], cube.faces.U.colors[1], cube.faces.U.colors[2]);
      console.log('  L (orange):', cube.faces.L.colors[0], cube.faces.L.colors[1], cube.faces.L.colors[2]);
      console.log('  F (green):', cube.faces.F.colors[0], cube.faces.F.colors[1], cube.faces.F.colors[2]);
      console.log('  R (red):', cube.faces.R.colors[0], cube.faces.R.colors[1], cube.faces.R.colors[2]);
      console.log('  B (blue):', cube.faces.B.colors[0], cube.faces.B.colors[1], cube.faces.B.colors[2]);
      console.log('  D (yellow):', cube.faces.D.colors[0], cube.faces.D.colors[1], cube.faces.D.colors[2]);
      console.log('');
    }
  }
